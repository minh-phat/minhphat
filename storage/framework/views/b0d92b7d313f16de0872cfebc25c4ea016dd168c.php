                ...
                <div class="container" style="margin-top: 20px;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo e(url('saveCategory')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Assignment\resources\views/Admin/Category/add.blade.php ENDPATH**/ ?>