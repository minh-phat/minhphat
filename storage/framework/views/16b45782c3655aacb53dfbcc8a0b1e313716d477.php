                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="<?php echo e(url('registration')); ?>">Laptop</a>
                              </li>
                              <li class="nav-item">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="images/products/<?php echo e($row->productImage1); ?>" alt="#" width="100px" height="120px"/></figure>
                                    <h3><?php echo e($row->productName); ?></h3>
                                </div>
                            </div> 
...
<?php /**PATH C:\xampp\htdocs\laravel0905a\resources\views/0905a/home.blade.php ENDPATH**/ ?>