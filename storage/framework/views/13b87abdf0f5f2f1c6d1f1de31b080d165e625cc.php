...
<section class="container py-5">
    ...
    <div class="row" style="justify-content: center">
        <?php $__currentLoopData = $categoriesF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="<?php echo e(url('category/' . $cat->Category_ID)); ?>"><img
                        style="
                        display: block;
                        margin-left: auto;
                        margin-right: auto;
                        width: 70%;"
                        src="img/categories/<?php echo e($cat->Category_Image); ?>" class="rounded-circle img-fluid border"
                        style="box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
                </a>
                <h5 class="text-center mt-3 mb-3"><?php echo e($cat->Category_Name); ?></h5>
                <p class="text-center"><a class="btn btn-success" href="<?php echo e(url('category/' . $cat->Category_ID)); ?>"
...
<?php /**PATH C:\xampp\htdocs\MaleFashion\resources\views/Navigate/home.blade.php ENDPATH**/ ?>