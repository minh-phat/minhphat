        ...
        <div class="container" style="margin-top: 20px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo e(url('updateAdmin')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="username" value="<?php echo e($data->Admin_Username); ?>">
                        
                        <div class="md-3">
                            <label for="name" class="form-label">Admin Name</label>
                            <input type="text" name="name" class="form-control" placeholder="Enter admin name"
                                value="<?php echo e($data->Admin_Name); ?>">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <a href="<?php echo e(url('listAdmin')); ?>" class="btn btn-danger">Back</a>
                    </form>
...
<?php /**PATH C:\xampp\htdocs\Assignment\resources\views/Admin/Admins/edit.blade.php ENDPATH**/ ?>