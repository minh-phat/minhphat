                    ...
                    <form action="<?php echo e(url('saveCustomer')); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="username" type="text" class="form-control" placeholder="Username"
                                name="userName" value="<?php echo e(isset($data) ? $data->username : old('userName')); ?>" <?php echo isset($data) ? 'readonly' : ''?>>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control" placeholder="Name" name="name"
                                value="<?php echo e(isset($data) ? $data->name : old('name')); ?>" <?php echo isset($data) ? 'readonly' : ''?>>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" class="form-control" placeholder="Demo@gmail.com"
                                name="email" value="<?php echo e(isset($data) ? $data->email : old('email')); ?>" <?php echo isset($data) ? 'readonly' : ''?>>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\Assignment\resources\views/Customer/customerRegister.blade.php ENDPATH**/ ?>