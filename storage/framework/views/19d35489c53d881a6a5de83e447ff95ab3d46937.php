                ...
                <div class="col-md-12">
                    ...
                    <?php if(Session::has('LoginID')): ?>
                        <div style="margin-right: 1%; float:right;box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
                            <a href="<?php echo e(url('addCategory')); ?>" class="btn btn-success">
                                <i class="fas fa-plus-circle"></i> Add</a>
                        </div>
                        <div style="margin-right: 1%; float:right;">
                            <form action="<?php echo e(url('searchCategory')); ?>" method="GET" style="box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr style="text-align: center; vertical-align:middle">
                                            ...
                                            <td>
                                                <img src="img/categories/<?php echo e($row->Category_Image); ?>" height="100px"
                                                    width="auto" style="border-radius: 10px;border: 1px solid #ced4da;">
                                            </td>
                                            <td>
                                                <a href="<?php echo e(url('editCategory/' . $row->Category_ID)); ?>"
                                                    class="btn btn-info">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="<?php echo e(url('deleteCategory/' . $row->Category_ID)); ?>"
...
<?php /**PATH C:\xampp\htdocs\Assignment\resources\views/Admin/Category/list.blade.php ENDPATH**/ ?>