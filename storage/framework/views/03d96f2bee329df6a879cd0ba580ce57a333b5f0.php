                ...
                <div class="col-md-12">
                    ...
                    <?php if(Session::has('LoginID')): ?>
                        <div style="margin-right: 1%; float:right;">
                            <?php if(session()->get('Class') == 'Product Operator'): ?>
                                
                                <a class="btn btn-success disabled">
                                    <i class="fas fa-plus-circle"></i> Add</a>
                            <?php else: ?>
                                
                                <a href="<?php echo e(url('registrationAdmin')); ?>" class="btn btn-success">
                                    <i class="fas fa-plus-circle"></i> Add</a>
                            <?php endif; ?>
                        </div>
                        ...
                        <div style="margin-right: 1%; float:right;">
                            <form action="<?php echo e(url('searchAdmin')); ?>" method="GET">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr style="text-align: center; vertical-align:middle">
                                            ...
                                            <td><?php echo e($row->Admin_Class); ?></td>
                                            <td>
                                                <?php if(session()->get('Class') == 'Product Operator'): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php if($row->Admin_Username == 'admin'): ?>
                                                        
                                                        <a href="<?php echo e(url('editAdmin/' . $row->Admin_Username)); ?>"
                                                            class="btn btn-info">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a class="btn btn-danger disabled">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <a href="<?php echo e(url('deleteAdmin/' . $row->Admin_Username)); ?>"
...
<?php /**PATH C:\xampp\htdocs\Assignment\resources\views/Admin/Admins/list.blade.php ENDPATH**/ ?>